...
class App:
    ...
    def update_role(self):
        ...
        self.account_label.config(text="Username:" if self.is_admin else "Account ID:")
    ...
    def admin_window(self):
        ...
        self.create_acc_button = ctk.CTkButton(admin_window, text="Create Account", command=self.create_account)
        self.create_acc_button.grid(row=0, column=0, padx=10, pady=10)

        self.delete_acc_button = ctk.CTkButton(admin_window, text="Delete Account", command=self.delete_account)
    ...
    def user_window(self, account_id, password):
        ...
        self.view_bal_button = ctk.CTkButton(user_window, text="View Balance", command=lambda: self.view_balance(account_id, password))
        self.view_bal_button.grid(row=0, column=0, padx=10, pady=10)

        self.deposit_button = ctk.CTkButton(user_window, text="Deposit Amount", command=lambda: self.deposit_amount(account_id, password))
        self.deposit_button.grid(row=0, column=1, padx=10, pady=10)

        self.withdraw_button = ctk.CTkButton(user_window, text="Withdraw Amount", command=lambda: self.withdraw_amount(account_id, password))
        self.withdraw_button.grid(row=0, column=2, padx=10, pady=10)

        self.transfer_button = ctk.CTkButton(user_window, text="Transfer Amount", command=lambda: self.transfer_amount(account_id, password))
        self.transfer_button.grid(row=1, column=0, padx=10, pady=10)

        self.view_trans_hist_button = ctk.CTkButton(user_window, text="View Transaction History", command=lambda: self.view_transaction_history(account_id, password))
    ...
    def create_account(self):
        ...
        create_acc_window.geometry("400x300")
        create_acc_window.configure(bg="#2c3e50")

        ctk.CTkLabel(create_acc_window, text="Account ID:").grid(row=0, column=0, padx=10, pady=10, sticky="W")
        account_id_entry = ctk.CTkEntry(create_acc_window, font=("Arial", 12))
        account_id_entry.grid(row=0, column=1, padx=10, pady=10)

        ctk.CTkLabel(create_acc_window, text="Password:").grid(row=1, column=0, padx=10, pady=10, sticky="W")
        password_entry = ctk.CTkEntry(create_acc_window, show="*", font=("Arial", 12))
        password_entry.grid(row=1, column=1, padx=10, pady=10)

        ctk.CTkLabel(create_acc_window, text="Email:").grid(row=2, column=0, padx=10, pady=10, sticky="W")
        email_entry = ctk.CTkEntry(create_acc_window, font=("Arial", 12))
        email_entry.grid(row=2, column=1, padx=10, pady=10)

        ctk.CTkLabel(create_acc_window, text="Phone:").grid(row=3, column=0, padx=10, pady=10, sticky="W")
        phone_entry = ctk.CTkEntry(create_acc_window, font=("Arial", 12))
        phone_entry.grid(row=3, column=1, padx=10, pady=10)

        ctk.CTkLabel(create_acc_window, text="Address:").grid(row=4, column=0, padx=10, pady=10, sticky="W")
        address_entry = ctk.CTkEntry(create_acc_window, font=("Arial", 12))
        address_entry.grid(row=4, column=1, padx=10, pady=10)

        ctk.CTkLabel(create_acc_window, text="Balance:").grid(row=5, column=0, padx=10, pady=10, sticky="W")
        balance_entry = ctk.CTkEntry(create_acc_window, font=("Arial", 12))
        balance_entry.grid(row=5, column=1, padx=10, pady=10)

        create_button = ctk.CTkButton(create_acc_window, text="Create", command=create)
    ...
    def delete_account(self):
        ...
        delete_acc_window.configure(bg="#2c3e50")

        ctk.CTkLabel(delete_acc_window, text="Account ID:").grid(row=0, column=0, padx=10, pady=10, sticky="W")
        account_id_entry = ctk.CTkEntry(delete_acc_window, font=("Arial", 12))
        account_id_entry.grid(row=0, column=1, padx=10, pady=10)

        delete_button = ctk.CTkButton(delete_acc_window, text="Delete", command=delete)
    ...
    def deposit_amount(self, account_id, password):
        ...
        deposit_window.configure(bg="#2c3e50")

        ctk.CTkLabel(deposit_window, text="Amount:").grid(row=0, column=0, padx=10, pady=10, sticky="W")
        amount_entry = ctk.CTkEntry(deposit_window, font=("Arial", 12))
        amount_entry.grid(row=0, column=1, padx=10, pady=10)

        deposit_button = ctk.CTkButton(deposit_window, text="Deposit", command=deposit)
    ...
    def withdraw_amount(self, account_id, password):
        ...
        withdraw_window.configure(bg="#2c3e50")

        ctk.CTkLabel(withdraw_window, text="Amount:").grid(row=0, column=0, padx=10, pady=10, sticky="W")
        amount_entry = ctk.CTkEntry(withdraw_window, font=("Arial", 12))
        amount_entry.grid(row=0, column=1, padx=10, pady=10)

        withdraw_button = ctk.CTkButton(withdraw_window, text="Withdraw", command=withdraw)
    ...
    def transfer_amount(self, account_id, password):
        ...
        ctk.CTkLabel(transfer_window, text="Receiver Account ID:").grid(row=0, column=0, padx=10, pady=10, sticky="W")
        receiver_account_id_entry = ctk.CTkEntry(transfer_window, font=("Arial", 12))
        receiver_account_id_entry.grid(row=0, column=1, padx=10, pady=10)

        ctk.CTkLabel(transfer_window, text="Amount:").grid(row=1, column=0, padx=10, pady=10, sticky="W")
        amount_entry = ctk.CTkEntry(transfer_window, font=("Arial", 12))
        amount_entry.grid(row=1, column=1, padx=10, pady=10)

        transfer_button = ctk.CTkButton(transfer_window, text="Transfer", command=transfer)
    ...
    def view_transaction_history(self, account_id, password):
        ...
        for i, transaction in enumerate(transactions):
            ctk.CTkLabel(history_window, text=f"Date: {transaction[3]}, Type: {transaction[1]}, Amount: {transaction[2]}, Description: {transaction[4]}").grid(row=i, column=0, padx=10, pady=10)
